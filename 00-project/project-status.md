...
| `/00-project/decisions/DEC-016-subscriptions-iap.md` | @product-architect + @developer | 2026-03-22 |
| `/00-project/decisions/DEC-017-ci-cd.md` | @product-architect + @developer | 2026-03-22 |
...
|---|---|---|
| ~~**Tech stack — ALL DECISIONS COMPLETE**~~ | All 12 tech stack decisions finalized (DEC-007 to DEC-018). Core stack + infrastructure + tooling fully decided. Architecture document complete. Unblocks: database schema, API spec, sprint plan. | **RESOLVED** — No longer a blocker. |
...
| 16 | Subscriptions / IAP | RevenueCat (free tier up to $2.5K MRR) | @product-architect + @developer | 2026-03-22 | Active |
| 17 | CI/CD pipeline | GitHub Actions + Fastlane (mobile signing/store deployment) | @product-architect + @developer | 2026-03-22 | Active |
| 18 | Error monitoring | Sentry (free tier 5K events/month) — Flutter + ASP.NET Core + Blazor | @product-architect + @developer | 2026-03-22 | Active |

---

## Open Questions

1. ~~What is the right tech stack?~~ — **FULLY RESOLVED:** Core stack (Flutter + Blazor WASM + ASP.NET Core + PostgreSQL + ASP.NET Identity) + Infrastructure (self-managed VPS, local disk → R2, FCM, Firebase Analytics) + Tooling (RevenueCat, GitHub Actions + Fastlane, Sentry). All 12 decisions documented in DEC-007 through DEC-018. Architecture document at `/03-product/technical/architecture.md`.
